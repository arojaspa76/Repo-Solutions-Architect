...
# Description: GENERAL domain sub-agent — cross-domain questions, policies, greetings
...
PROMPT_PATH = Path("configs/prompts/agents/general.yaml")


class AgenteGeneral(BaseGenAIDemoAgent):
    """GENERAL domain sub-agent."""
