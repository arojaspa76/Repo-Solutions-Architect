...
# Description: LICUADOS domain sub-agent — LPG, propane, butane, storage, transport
...
PROMPT_PATH = Path("configs/prompts/agents/licuados.yaml")


class AgenteLicuados(BaseGenAIDemoAgent):
    """LICUADOS domain sub-agent."""
