...
# Description: COMBUSTIBLES domain sub-agent — fuels, distribution, pricing, demand
...
PROMPT_PATH = Path("configs/prompts/agents/combustibles.yaml")


class AgenteCombustibles(BaseGenAIDemoAgent):
    """COMBUSTIBLES domain sub-agent."""
