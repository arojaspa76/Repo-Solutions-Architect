...
# Description: GAS domain sub-agent — natural gas, LNG, pipelines, compression
...
PROMPT_PATH = Path("configs/prompts/agents/gas.yaml")


class AgenteGas(BaseGenAIDemoAgent):
    """GAS domain sub-agent."""
